...
public interface TabStripBuild {
     ...
     * @return {@link TabStripBuild}
     */
    TabStripBuild addTabItem(Drawable drawable, String text);
     ...
     * @return {@link TabStripBuild}
     */
    TabStripBuild addTabItem(@DrawableRes int drawable, String text);
     ...
     * @return {@link TabStripBuild}
     */
    TabStripBuild addTabItem(Drawable drawable, String text, @ColorInt int selectedColor);
     ...
     * @return {@link TabStripBuild}
     */
    TabStripBuild addTabItem(@DrawableRes int drawable, String text, @ColorInt int selectedColor);
     ...
     * @return {@link TabStripBuild}
     */
    TabStripBuild addTabItem(@DrawableRes int drawable, @DrawableRes int selectedDrawable, String text);
     ...
     * @return {@link TabStripBuild}
     */
    TabStripBuild addTabItem(@DrawableRes int drawable, @DrawableRes int selectedDrawable, String text, @ColorInt int selectedColor);
     ...
     * @return {@link TabStripBuild}
     */
    TabStripBuild addTabItem(Drawable drawable, Drawable selectedDrawable, String text, @ColorInt int selectedColor);
     ...
     * @return {@link TabStripBuild}
     */
    TabStripBuild addTabItem(Drawable drawable, Drawable selectedDrawable, String text);
